...
const content: VerticalPageContent = {
  ...
  image: '/active-adult-hero.jpg', imageAlt: 'Active older couple walking together in their neighborhood',
  residentImage: '/active-adult-resident.jpg', residentImageAlt: 'Older adults walking together through a park',
