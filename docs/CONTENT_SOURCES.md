...
- All positioning, service, geography, contact, proof, and claim constraints derive from the supplied `00–04` website build package, `PRD.md`, and `SDD.md`.
- The operating-history statement is limited to the approved source wording: approximately 10 years refining Ascend's fitness operation in Lake Mary, Florida.
- No testimonials, client logos, case studies, outcomes, credentials, statistics, partnerships, or nationwide coverage claims are used.
...
These are candidate launch images and require final owner approval before a public production deployment.
